...
name: eazy-esg
description: >
  Eazy ESG is a comprehensive ESG management assistant for Corporate ESG Managers. Use this skill
  whenever a user mentions ESG reporting, sustainability disclosures, GRI, TCFD, ASRS, climate
  reporting, emissions data, ESG data collection, compliance gaps, sustainability frameworks,
  board ESG summaries, or uploading ESG-related spreadsheets or documents. Trigger this skill for
  any task involving environmental, social, or governance data — even if the user doesn't say "ESG"
  explicitly (e.g. "help me with our climate disclosure" or "I need to fill in our Scope 1 numbers").
  This skill manages a full agent workflow covering data intake, framework mapping, gap analysis,
  report drafting, compliance monitoring, and analysis of existing sustainability reports.
---
